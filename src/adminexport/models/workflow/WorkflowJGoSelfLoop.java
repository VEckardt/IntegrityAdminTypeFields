...
public class WorkflowJGoSelfLoop extends WorkflowJGoLink
{
    ...
    /**
     * Over-rides the method in parent class, in order for
     * getFromType() and getToType() to return the same Type.
     *
    ...
    /**
     * Over-rides the method in ancestor class, in order for
     * getFromPort() and getToPort() to return the same port.
     *
    ...
    /**
     * Calculates the shape of this self-loop. Over-rides the 
     * default behavior, which is to draw a straight line, in JGoLink.
     *
