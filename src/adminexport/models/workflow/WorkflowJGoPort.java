...
/**
 * An oval shaped port, where the link arrowheads connect to 
...
public class WorkflowJGoPort extends JGoPort
{
    ...
    /**
     * Computes the link entry point to this port on the edge 
     * of the ellipse. Copied from jgo ../examples/layoutdemo.
     * 
