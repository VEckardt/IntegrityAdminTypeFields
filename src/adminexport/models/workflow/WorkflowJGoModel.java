...
/**
 * The model (document) for WorkflowJGoView.
 * The model contains nodes, links, and self-loops,
 * it interacts with them, and performs layout.
 */
public class WorkflowJGoModel extends JGoDocument
{
     ...
     * The nodes are added behind all objects.
     *
     ...
     * The links are added in front of all objects, so that the
     * labels are not blocked by the nodes, if there is an
     * overlap.
     *
     ...
     *
     * @param direction The direction of the layout. See the 
     *        constants on top of this file.
     */
